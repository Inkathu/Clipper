...
namespace RembyClipper2.Helpers
{
    ...
    public static class Upload
    {
        ...
        {
            //requestUri = new Uri(requestUri.AbsoluteUri + @"?x-remby-drupal-user_id=301&x-remby-drupal-user_token=ab0cd47584480c1194fed99cc6e87c91");
            ...
            //webrequest.Referer = "http://store.remby.com/test/upload_demo.html";
            //webrequest.Expect = "";
            headers = new NameValueCollection();
//            headers.Add("Cache-Control", "max-age=0");
//            headers.Add("Origin", "http://store.remby.com");
//            headers.Add("Accept-Encoding", "gzip,deflate,sdch");
//            headers.Add("Accept-Language", "ru-RU,ru;q=0.8,en-US;q=0.6,en;q=0.4");
//            headers.Add("Accept-Charset", "windows-1251,utf-8;q=0.7,*;q=0.3");
            if (headers != null)
            {
...
//            webrequest.CookieContainer.Add(requestUri, new CookieCollection()
//                                               { 
//                                                   new Cookie("__unam", "1bc846b-13110ceb14d-20fe1e27-2"),
//                                                   new Cookie("SESS2e5f0a21ce00a93a3fa371cd6a6ba454", "40bfb017b211c5c08c49790d19ed7842"),
//                                                   new Cookie("DRUPAL_UID", "1"),
//                                                   new Cookie("__utma", "44484283.1583626081.1308161716.1321628873.1322076725.124"),
//                                                   new Cookie("__utmc", "44484283"),
//                                                   new Cookie("__utmz", @"44484283.1321083102.119.26.utmcsr=pms.remby.com|utmccn=(referral)|utmcmd=referral|utmcct=/issues/2739"),
//                                               });
            ...
            using (Stream requestStream = webrequest.GetRequestStream())
            {
                ...
                if (fileData != null)
                {
                    ...
                    byte[] buffer = new Byte[checked((uint)Math.Min(4096*10, (int)fileData.Length))];
                    int bytesRead;
        ...
        public static WebResponse PostContent(Uri requestUri, NameValueCollection postData, CookieContainer cookies, NameValueCollection headers)
        {
            HttpWebRequest webrequest = (HttpWebRequest)WebRequest.Create(requestUri);
            if (headers != null)
            {
            ...
            string session = string.Format(@"session=""{0}""", AppConfig.Instance.SessionID);
            string cookie = webrequest.Headers["Cookie"];
            if(!cookie.HasValue())
            {
                webrequest.Headers["Cookie"] = session;
            } else
            {
        ...
        {
            using (Stream fileData = File.Open(fileName, FileMode.Open, FileAccess.Read, FileShare.Read))
            {
                return PostStream(requestUri, postData, fileData, fileName, fileContentType, fileFieldName, cookies,
                                headers);
            }
        }
        ...
        /// <param name="headers">Optional, headers to be added to request.</param>
        /// <returns></returns>
        public static WebResponse PostStream(Uri requestUri, NameValueCollection postData, Stream fileData, string fileName,
                                           string fileContentType, string fileFieldName, CookieContainer cookies,
                                           NameValueCollection headers)
        {
...
//                }
        ...
        public static string RequestUrlByGet(string url)
        {
            ...
            request.Method = "GET";
            request.Headers.Add("Cookie", string.Format(@"session=""{0}""", AppConfig.Instance.SessionID));
