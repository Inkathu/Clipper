...
namespace RembyClipper2.VideoEngine
{
    public partial class WebcamSurface : UserControl, IWebCamSurface
    {
        ...
        public new event CustomButtonClicked OnMove;
        
        public WebcamSurface()
        {
            InitializeComponent();
            this.toolTip1.SetToolTip(this.pictureBoxMinMax, Localization.LanguageMgr.LM.GetText(Labels.VideoRecorder_ZoomIn));
            this.toolTip1.SetToolTip(this.pictureBoxClose, Localization.LanguageMgr.LM.GetText(Labels.VideoRecorder_CloseCam));
        ...
        private void pictureBoxMinMax_Click(object sender, EventArgs e)
        {
            if (!blownUp)
            {
                ...
                this.toolTip1.SetToolTip(this.pictureBoxMinMax, Localization.LanguageMgr.LM.GetText(Labels.VideoRecorder_ZoomOut));
