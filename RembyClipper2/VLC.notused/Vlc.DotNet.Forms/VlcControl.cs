...
namespace Vlc.DotNet.Forms
{
    ...
    {
        private static IntPtr _myEventCallbak;

        private IntPtr myEventCallback { get { return VlcControl._myEventCallbak; } set { VlcControl._myEventCallbak = value; } }
        ...
        private void InitVlcMediaPlayer()
        {
            ...
            if (VlcMediaPlayerEventManager == IntPtr.Zero)
                return;
            VlcControl.callback = OnVlcEvent;
            myEventCallback = Marshal.GetFunctionPointerForDelegate(VlcControl.callback);
            GC.KeepAlive(VlcControl.callback);
        ...
        public static LibVlcMethods.EventCallbackDelegate callback;
