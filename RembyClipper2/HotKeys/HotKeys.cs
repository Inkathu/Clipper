...
namespace RembyClipper2.HotKeys
{
    public class Hotkey : IMessageFilter
    {
        ...
        private bool OnPressed()
        {
            ...
            Debug.WriteLine("onpress step 1");
            HandledEventArgs handledEventArgs = new HandledEventArgs(false);
            if (this.Pressed != null)
            {
                Debug.WriteLine("onpress step 2");
                //HotKeysHandler.ClearMessages();
                this.Pressed(this, handledEventArgs);
            }

            // Return whether we handled the event or not
            Debug.WriteLine("onpress step 3");
    ...
    public class HotKey2 : IMessageFilter
    {
